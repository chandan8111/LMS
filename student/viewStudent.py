...
class studentWindow:
    ...
    def addframe(self):
        ...
        self.label7 = Label(self.frame, text="Enter Student id and \npress View Data Button", fg='red')
        ...
        self.but = Button(self.frame, text='View Data >>', width=18, bg='light grey', fg='black',
